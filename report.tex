...
\begin{table}[h]
\centering
\caption{\added{[NEW]} Effect of unobserved confounding (varying number of latent nodes). \added{Fixed: $n=5$, density$=0.5$, $B=5000$, 50 trials, $\delta=0.3$, fanout$=2$. TsP-Color uses graph-coloring intervention groups; TsP-Sep uses strongly separating sets~\cite{kocaoglu2017experimental}.}}
\label{tab:confounding}
\begin{tabular}{c|ccc}
\toprule
\# Latents & Random & TsP-Color & TsP-Sep \\
\midrule
